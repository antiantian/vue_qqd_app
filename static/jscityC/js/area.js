$.fn.getArea = function(shenfen,chengshi,quyu){
	var sfp = shenfen+' p'
	var csp = chengshi+' p'
	var qyp = quyu+' p'
 ...
 $(function(){
	...
	//console.log(csgsmr);
	//console.log(sfgsmr[1].name);
	
	var extProvince = $("#extProvince").val();
	var extCity = $("#extCity").val();
	var extArea =  $("#extArea").val();
		
	//var extProvince =1;
	//var extCity =1;
	//var extArea ="1";

	if(extProvince && extCity && extArea){
		alert("编辑时值存在");
	}else{
...
$(".m_zlxg2 li").click(function(){
	
	$(this).parent("ul").parent(".m_zlxg2").hide()
	})
/*---------------------------------------------------------------------*/
...
//{name:'县', areaList:['崇明县']}
/**
定区','浦东新区','金山区','松江区','青浦区','南汇区','奉贤区','崇明县']},		   
{name:'县', areaList:['崇明县']}
*/

var provinceList = [
{name:'上海市', cityList:[		   
{name:'市辖区', areaList:['请选择区县','黄浦区','卢湾区','徐汇区','长宁区','静安区','普陀区','闸北区','虹口区','杨浦区','闵行区','宝山区','嘉定区','浦东新区','金山区','松江区','青浦区','南汇区','奉贤区','崇明县']},		   
{name:'县', areaList:['崇明县']}
]},
